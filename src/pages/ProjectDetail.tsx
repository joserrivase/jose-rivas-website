...
const projectsData = {
  langlio: {
    ...
    whyBuilt: "This idea came from playing different daily guessing games, with one in particular sparking the idea: Worldle. I thought of other world related topics and I cam across languages. This was something that wasn't already made, it involved my curiosity of the world, and seemed like a fun project to create. It would be a plus if people actually wanted to use it.",
    howBuilt: "I build Langlio using a simple website stack of HTML to set up the website, Java Script to store the logic used in the game, and CSS for the visual touches. this was facilitated with the use of cursor to help implement some of the code. The languages were picked from the top 70 spoken languages in the world, the sentences were formed by a list of quotes, and the translations where taken by google translate. Google Analytics was used to run analysis on usage, sources of new users, retention, churn, and user interactions.",
    learned: "This project taught me the whole process of creating a product: starting from an idea, to brainstorming of what it could look like, then creating the game, and maintaining the game, while getting user feedback for improvements. I learned how to design a website, how to run analytics to make product decisions, and how to work with a team to manage the different role needed to create and run a product.",
    outcome: "Langlio was able to reach 1000 views in the first month, across 9 countries. I was able to get user feedback on confusing parts of the layout and make improvements that showed an improvement in user retention by 20%."
  },
  "ai-listing-improver": {
    id: 2,
